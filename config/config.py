...
DURATION_LIMIT_MIN = int(getenv("DURATION_LIMIT", "900000000000000000000000"))

SONG_DOWNLOAD_DURATION = int(getenv("SONG_DOWNLOAD_DURATION_LIMIT", "18000000000000000000000"))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Jatindalal875/musi",
)
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "main")
GITHUB_REPO = getenv("GITHUB_REPO", "https://github.com/Jatindalal875/musi")
...
AUTO_LEAVE_ASSISTANT_TIME = int(getenv("ASSISTANT_LEAVE_TIME", "180"))
AUTO_SUGGESTION_TIME = int(getenv("AUTO_SUGGESTION_TIME", "120"))
...
START_IMG_URL = getenv("START_IMG_URL", "https://te.legra.ph/file/bcb63300e6794512193c6.jpg")

PING_IMG_URL = getenv(
    "PING_IMG_URL",
    "https://te.legra.ph/file/66e8e53c21c73f34c58f4.jpg",
)
...
STATS_IMG_URL = "https://te.legra.ph/file/3c09a6ae3dc4e271aaf28.jpg"
...
if PING_IMG_URL:
    if PING_IMG_URL != "https://te.legra.ph/file/66e8e53c21c73f34c58f4.jpg":
        if not re.match("(?:http|https)://", PING_IMG_URL):
            PING_IMG_URL = "https://te.legra.ph/file/66e8e53c21c73f34c58f4.jpg"

if START_IMG_URL:
    if START_IMG_URL != "https://te.legra.ph/file/bcb63300e6794512193c6.jpg":
        if not re.match("(?:http|https)://", START_IMG_URL):
            START_IMG_URL = "https://te.legra.ph/file/bcb63300e6794512193c6.jpg"
